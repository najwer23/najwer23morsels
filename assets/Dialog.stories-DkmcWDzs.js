import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./react-D1sJ83FZ.js";import{t as r}from"./jsx-runtime-DnaggZxp.js";import{n as i,t as a}from"./getCssVariableStyle-rhjbzvYQ.js";import{n as o,t as s}from"./textbox-D98-YxRJ.js";import{n as c,t as l}from"./button-0EMNk7V8.js";var u,d,f,p,m=t((()=>{u=`_n23mDialog_19qdr_2`,d=`_dialog_19qdr_5`,f=`_dialogCloseButton_19qdr_17`,p={n23mDialog:u,dialog:d,dialogCloseButton:f}})),h,g,_,v=t((()=>{h=e(n(),1),l(),s(),i(),m(),g=r(),_=({children:e,open:t,widthMax:n,title:r,onCancel:i,className:s,style:l,...u})=>{let d=(0,h.useRef)(null);return(0,h.useEffect)(()=>{if(t)d.current?.showModal(),document.body.style.paddingRight=`${window.innerWidth-document.body.clientWidth}px`,document.body.style.overflow=`hidden`;else{d.current?.classList.add(p.minimize);let e=setTimeout(()=>{d.current?.close(),d.current?.classList.remove(p.minimize),document.body.style.paddingRight=`0`,document.body.style.overflow=``},0);return()=>clearTimeout(e)}},[t]),(0,g.jsx)(`div`,{className:[p.n23mDialog,`n23mDialog`,s].filter(Boolean).join(` `),...u,style:{...a({"--dialog-wm":n}),...l},children:(0,g.jsxs)(`dialog`,{className:[r?p.hasTitle:``,p.dialog].join(` `),"modal-mode":`mega`,ref:d,onCancel:i,children:[(0,g.jsx)(`div`,{className:p.dialogCloseButton,style:{display:t?`block`:`none`},children:(0,g.jsx)(c,{onClick:i,"aria-label":`close dialog`,height:`25px`,width:`60px`,backgroundColor:`#ff3333`,children:(0,g.jsx)(o,{tag:`h2`,mobileSize:14,desktopSize:14,color:`white`,children:`Close`})})}),(0,g.jsx)(`article`,{children:e})]})})},_.displayName=`Dialog`,_.__docgenInfo={description:``,methods:[],displayName:`Dialog`}})),y=t((()=>{v()})),b,x,S,C,w;t((()=>{b=e(n(),1),l(),s(),y(),x=r(),S={title:`Dialog/Dialog`,component:_,parameters:{layout:`centered`,docs:{description:{component:`
