import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as v}from"./iframe-BKJq2Zu4.js";import{T as d}from"./TextBox-C2EOz3TH.js";import{L as T}from"./Loader-CU1fxyJc.js";import{g as j}from"./getCssVariableStyle-DXeVW4yL.js";import"./preload-helper-PPVm8Dsz.js";const z="_n23mGridFlex_19vve_2",_="_n23mGridContainer_19vve_3",q="_n23mGridColumns_19vve_21",w={n23mGridFlex:z,n23mGridContainer:_,n23mGridColumns:q},n=({children:r,widthMin:o="0px",widthMax:i="1920px",padding:u="0px",margin:x="auto",layout:t,gap:a,col:s,loading:g=!1,justifyContent:G,alignItems:k,minHeight:f,flexWrap:S,className:h,style:C,...y})=>{if(t==="container"||t==="flex")return e.jsxs("div",{className:[w["n23mGrid"+t.charAt(0).toUpperCase()+t.slice(1)],"n23mGrid"+t.charAt(0).toUpperCase()+t.slice(1),h].filter(Boolean).join(" "),style:{...j({"--grid-p":u,"--grid-m":x,"--grid-jc":G,"--grid-cg":a?.col,"--grid-rg":a?.row,"--grid-ai":k,"--grid-fw":S,"--grid-mh":f,"--grid-wn":o,"--grid-wx":i}),...C},...y,children:[!g&&r,g&&e.jsx(T,{minHeight:`${f}`})]});if(!a||!s)throw new Error('When layout="columns", gap and col props are required');return e.jsx("div",{className:[w.n23mGridColumns,"n23mGridColumns",h].filter(Boolean).join(" "),style:{"--grid-cm":s.mobile.toString(),"--grid-ct":s.tablet.toString(),"--grid-csd":s.smallDesktop.toString(),"--grid-cd":s.desktop.toString(),"--grid-cg":a.col,"--grid-rg":a.row},...y,children:r})};n.displayName="Grid";n.__docgenInfo={description:"",methods:[],displayName:"Grid",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},widthMin:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'0px'",computed:!1}},widthMax:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'1920px'",computed:!1}},padding:{required:!1,tsType:{name:"union",raw:"string | 0",elements:[{name:"string"},{name:"literal",value:"0"}]},description:"",defaultValue:{value:"'0px'",computed:!1}},margin:{required:!1,tsType:{name:"union",raw:"string | 0",elements:[{name:"string"},{name:"literal",value:"0"}]},description:"",defaultValue:{value:"'auto'",computed:!1}},minHeight:{required:!1,tsType:{name:"string"},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},gap:{required:!1,tsType:{name:"Gap"},description:""},col:{required:!1,tsType:{name:"Col"},description:""},layout:{required:!0,tsType:{name:"union",raw:"'columns' | 'container' | 'flex'",elements:[{name:"literal",value:"'columns'"},{name:"literal",value:"'container'"},{name:"literal",value:"'flex'"}]},description:""},justifyContent:{required:!1,tsType:{name:"string"},description:""},alignItems:{required:!1,tsType:{name:"string"},description:""},flexWrap:{required:!1,tsType:{name:"string"},description:""},style:{required:!1,tsType:{name:"ReactCSSProperties",raw:"React.CSSProperties"},description:""}}};const A={title:"Grid/Grid",component:n,parameters:{layout:"centered",docs:{description:{component:`
