import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{e as B,r as c}from"./iframe-BTNfAsan.js";import{L as Z}from"./Loader-CdV_WFc2.js";import{a as ee,I as ne}from"./IconArrowRight-DaV6Kolw.js";import{B as M}from"./Button-B3Klu473.js";import{u as le}from"./useWindowSize-B9z9HbRj.js";import{T as re}from"./TextBox-DhZTsRfC.js";const te="_n23mSlider_10mao_2",ie="_n23mSliderContainerSlider_10mao_6",se="_n23mSliderSlideWrapper_10mao_16",oe="_n23mSliderSlide_10mao_16",ae="_n23mSliderControls_10mao_37",de="_n23mSliderControlsButtons_10mao_44",ce="_n23mSliderCounter_10mao_50",y={n23mSlider:te,n23mSliderContainerSlider:ie,n23mSliderSlideWrapper:se,n23mSliderSlide:oe,n23mSliderControls:ae,n23mSliderControlsButtons:de,n23mSliderCounter:ce},I=(l,u,p=!1,o)=>(p?l.slice(0,u):l.slice(-u)).map((d,S)=>B.cloneElement(d,{key:`${p?"clone-first":"clone-last"}-${S} ${o}`,className:d.props.className})),x=({isCircular:l=!1,children:u,className:p,loading:o=!1,loaderColor:d="black",slidesConfig:S={mobile:{items:1,slidesToScroll:1},tablet:{items:2,slidesToScroll:2},desktop:{items:3,slidesToScroll:3}},slideSpacingPx:v=10})=>{const i=B.Children.toArray(u).filter(B.isValidElement),{width:A}=le(),[F,Y]=c.useState(0),R=c.useRef(null),[s,E]=c.useState(l?i.length*2:0),[h,T]=c.useState(!1),g=c.useRef([]),[O,V]=c.useState(null),[X,z]=c.useState(0);let r,w,_,L;A<767.98?(r=S.mobile.items,w=S.mobile.slidesToScroll,_="transform 0.4s cubic-bezier(.4,0,.2,1)",L=450):A<1199.98?(r=S.tablet.items,w=S.tablet.slidesToScroll,_="transform 0.65s cubic-bezier(0.645, 0.045, 0.355, 1)",L=700):(r=S.desktop.items,w=S.desktop.slidesToScroll,_="transform 0.65s cubic-bezier(0.645, 0.045, 0.355, 1)",L=700),c.useLayoutEffect(()=>{let n;const a=()=>{R.current&&Y(R.current.offsetWidth),E(l?i.length*2:0)},t=()=>{clearTimeout(n),n=window.setTimeout(a,150),T(!1)};return a(),window.addEventListener("resize",t),()=>{clearTimeout(n),window.removeEventListener("resize",t)}},[o,l,r,i.length]);const f=r>0?(F-v*(r-1))/r:0;let j=l?[...I(i,i.length,!1,1),...I(i,i.length,!1,2),...i,...I(i,i.length,!0,3),...I(i,i.length,!0,4)]:i;const K=n=>{n.touches.length===1&&(V(n.touches[0].clientX),z(0))},U=n=>{O!==null&&z(n.touches[0].clientX-O)},G=()=>{X>50&&!(h||!l&&s===0)?P():X<-50&&!(h||!l&&s+r>=i.length)&&H(),V(null),z(0)};c.useLayoutEffect(()=>{g.current.forEach((n,a)=>{if(!n)return;let t=0,b=0;r==1&&i.length!=1?(t=40,b=40):r==2?(t=20,b=20):r==4?(t=10,b=10):r==3&&(t=12.5,b=12.5);const Q=(a-s)*(f+v-b)+(F-(f-t)*r-v*(r-1))/2;n.style.transition=h?_:"none",n.style.transform=`translateX(${Q}px)`})},[s,F,h,j.length,r,f,v,o]),c.useLayoutEffect(()=>{if(!h)return;let n;const a=()=>{let t=s;s<r*2&&l?t=s+i.length*2:s>=i.length*2+r&&l&&(t=s-i.length),console.log(t),t!==s&&l&&E(t),T(!1),g.current.forEach(b=>{b&&b.removeEventListener("transitionend",a)}),clearTimeout(n)};return g.current.forEach(t=>{t&&t.addEventListener("transitionend",a)}),n=window.setTimeout(()=>{T(!1),g.current.forEach(t=>{t&&t.removeEventListener("transitionend",a)})},L),()=>{g.current.forEach(t=>{t&&t.removeEventListener("transitionend",a)}),clearTimeout(n)}},[s,l,h,i.length,r,j.length,o]);const H=()=>{h||(T(!0),E(n=>n+w))},P=()=>{h||(T(!0),E(n=>n-w))};g.current.length!==j.length&&(g.current=Array(j.length).fill(null));const J=()=>{if(!l)return s;const n=i.length;return n<1?0:(s+n)%n};return e.jsxs("div",{className:[y.n23mSlider,"n23mSlider",p].filter(Boolean).join(" "),style:{height:o?"calc(100% - 2px)":"calc(100% - 60px)"},onTouchStart:K,onTouchMove:U,onTouchEnd:G,children:[o&&e.jsx(Z,{loaderColor:d}),!o&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:[y.n23mSliderContainerSlider].filter(Boolean).join(" "),children:e.jsx("div",{className:[y.n23mSliderSlideWrapper,"n23mSliderSlideWrapper"].join(" "),ref:R,style:{display:"flex",gap:`${v}px`,overflow:"hidden",width:"100%",boxSizing:"border-box"},children:j.map((n,a)=>e.jsx("div",{ref:t=>{g.current[a]=t},className:y.n23mSliderSlide,style:{width:r==1&&i.length==1?"100%":r==1?`calc(${f}px - 40px)`:r==2?`calc(${f}px - 20px)`:r==3?`calc(${f}px - 12.5px)`:r==4?`calc(${f}px - 10px)`:`${f}px`},"aria-hidden":a<s||a>=s+r,children:n},n.key??a))})}),e.jsxs("div",{className:[y.n23mSliderControls,"n23mSliderControls"].join(" "),style:{justifyContent:r==1?"space-between":"flex-end"},children:[r==1&&e.jsx("div",{className:[y.n23mSliderCounter,"n23mSliderCounter"].join(" "),children:e.jsx(re,{mobileSize:16,desktopSize:16,color:"black",children:l?`${J()+1} / ${i.length}`:`${s+1} / ${i.length}`})}),e.jsxs("div",{className:[y.n23mSliderControlsButtons,"n23mSliderControlsButtons"].join(" "),children:[e.jsx(M,{height:"50px",width:"50px",backgroundColor:"#F2F0EF",padding:0,title:"Prev",onClick:P,borderColor:"black",backgroundColorDisabled:"#F2F0EF",disabled:h||!l&&s===0,children:e.jsx(ee,{width:24,height:24})}),e.jsx(M,{height:"50px",width:"50px",backgroundColor:"#F2F0EF",padding:0,title:"Next",borderColor:"black",backgroundColorDisabled:"#F2F0EF",onClick:H,disabled:h||!l&&s+r>=i.length,children:e.jsx(ne,{width:24,height:24})})]})]})]})]})};x.displayName="Slider";x.__docgenInfo={description:"",methods:[],displayName:"Slider",props:{isCircular:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},children:{required:!0,tsType:{name:"ReactNode"},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},loaderColor:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'black'",computed:!1}},slidesConfig:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  mobile: {
    items: number;
