import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as U,r as a}from"./iframe-CXAA5pxq.js";import{B as Y}from"./Button-BfVOQbvt.js";import{u as te}from"./useWindowSize-BvNl6jih.js";import{a as ie,I as se}from"./IconArrowRight--vpQEYqS.js";import{L as oe}from"./Loader-wieurjYN.js";import{T as ae}from"./TextBox-8nHxQ-pk.js";import"./preload-helper-PPVm8Dsz.js";const de="_n23mSlider_u87e8_2",ce="_dragging_u87e8_5",ue="_n23mSliderContainerSlider_u87e8_11",me="_n23mSliderSlideWrapper_u87e8_21",pe="_n23mSliderSlide_u87e8_21",Se="_n23mSliderControls_u87e8_42",he="_n23mSliderControlsButtons_u87e8_49",ge="_n23mSliderCounter_u87e8_55",p={n23mSlider:de,dragging:ce,n23mSliderContainerSlider:ue,n23mSliderSlideWrapper:me,n23mSliderSlide:pe,n23mSliderControls:Se,n23mSliderControlsButtons:he,n23mSliderCounter:ge},N=(n,S,h=!1,o)=>(h?n.slice(0,S):n.slice(-S)).map((d,g)=>U.cloneElement(d,{key:`${h?"clone-first":"clone-last"}-${g} ${o}`,className:d.props.className})),v=({isCircular:n=!1,children:S,className:h,loading:o=!1,loaderColor:d="black",slidesConfig:g={mobile:{items:1,slidesToScroll:1},tablet:{items:2,slidesToScroll:2},desktop:{items:3,slidesToScroll:3}},slideSpacingPx:y=10})=>{const t=U.Children.toArray(S).filter(U.isValidElement),{width:M}=te(),[X,K]=a.useState(0),z=a.useRef(null),f=a.useRef(null),[s,C]=a.useState(n?t.length*2:0),[c,E]=a.useState(!1),k=a.useRef([]),[L,I]=a.useState(null),[D,T]=a.useState(0),R=a.useRef(!1);let l,w,W,q;M<767.98?(l=g.mobile.items,w=g.mobile.slidesToScroll,W="transform 0.4s cubic-bezier(.4,0,.2,1)",q=450):M<1199.98?(l=g.tablet.items,w=g.tablet.slidesToScroll,W="transform 0.4s cubic-bezier(.4,0,.2,1)",q=450):(l=g.desktop.items,w=g.desktop.slidesToScroll,W="transform 0.4s cubic-bezier(.4,0,.2,1)",q=450),a.useLayoutEffect(()=>{z.current&&K(z.current.offsetWidth),C(n?t.length*2:0)},[o,n,l,t.length,M]);const b=(X-y*(l-1))/l;let A=n?[...N(t,t.length,!1,1),...N(t,t.length,!1,2),...t,...N(t,t.length,!0,3),...N(t,t.length,!0,4)]:t;const G=r=>{r.touches.length===1&&(I(r.touches[0].clientX),T(0),R.current=!0,f.current&&f.current.classList.add(p.dragging))},J=r=>{L!==null&&T(r.touches[0].clientX-L)},Q=()=>{D>50&&!(c||!n&&s===0)?P():D<-50&&!(c||!n&&s+l>=t.length)&&V(),I(null),T(0),R.current=!1,f.current&&f.current.classList.remove(p.dragging)},Z=r=>{I(r.clientX),T(0),R.current=!0,f.current&&f.current.classList.add(p.dragging)},ee=r=>{L!==null&&T(r.clientX-L)},ne=()=>{D>50&&!(c||!n&&s===0)?P():D<-50&&!(c||!n&&s+l>=t.length)&&V(),I(null),T(0),R.current=!1,f.current&&f.current.classList.remove(p.dragging)};a.useLayoutEffect(()=>{k.current.forEach((r,m)=>{if(!r)return;let i=0,x=0;l===1&&t.length!==1?(i=40,x=40):l===2?(i=20,x=20):l===4?(i=10,x=10):l===3&&(i=12.5,x=12.5);const le=(m-s)*(b+y-x)+(X-(b-i)*l-y*(l-1))/2;r.style.transition=c?W:"none",r.style.transform=`translateX(${le}px)`})},[s,X,c,A.length,l,b,y,o]),a.useLayoutEffect(()=>{if(!c)return;let r;const m=()=>{let i=s;s<l*2&&n?i=s+t.length*2:s>=t.length*2+l&&n&&(i=s-t.length),i!==s&&n&&C(i),E(!1),k.current.forEach(x=>{x&&x.removeEventListener("transitionend",m)}),clearTimeout(r)};return k.current.forEach(i=>{i&&i.addEventListener("transitionend",m)}),r=window.setTimeout(()=>{E(!1),k.current.forEach(i=>{i&&i.removeEventListener("transitionend",m)})},q),()=>{k.current.forEach(i=>{i&&i.removeEventListener("transitionend",m)}),clearTimeout(r)}},[s,n,c,t.length,l,A.length,o]);const V=()=>{c||(E(!0),C(r=>r+w))},P=()=>{c||(E(!0),C(r=>r-w))},re=()=>{if(!n)return s;const r=t.length;return r<1?0:(s+r)%r};return e.jsxs("div",{ref:f,className:[p.n23mSlider,"n23mSlider",h].filter(Boolean).join(" "),style:{height:o?"calc(100% - 2px)":"calc(100% - 60px)"},children:[o&&e.jsx(oe,{loaderColor:d}),!o&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:[p.n23mSliderContainerSlider].filter(Boolean).join(" "),onTouchStart:G,onTouchMove:J,onTouchEnd:Q,onMouseDown:Z,onMouseMove:ee,onMouseUp:ne,children:e.jsx("div",{className:[p.n23mSliderSlideWrapper,"n23mSliderSlideWrapper"].join(" "),ref:z,style:{display:"flex",gap:`${y}px`,overflow:"hidden",width:"100%",boxSizing:"border-box"},children:A.map((r,m)=>e.jsx("div",{ref:i=>{k.current[m]=i},className:p.n23mSliderSlide,style:{width:l===1&&t.length===1?"100%":l===1?`calc(${b}px - 40px)`:l===2?`calc(${b}px - 20px)`:l===3?`calc(${b}px - 12.5px)`:l===4?`calc(${b}px - 10px)`:`${b}px`},"aria-hidden":m<s||m>=s+l,children:r},r.key??m))})}),e.jsxs("div",{className:[p.n23mSliderControls,"n23mSliderControls"].join(" "),style:{justifyContent:l===1?"space-between":"flex-end"},children:[l===1&&e.jsx("div",{className:[p.n23mSliderCounter,"n23mSliderCounter"].join(" "),children:e.jsx(ae,{mobileSize:16,desktopSize:16,color:"black",children:n?`${re()+1} / ${t.length}`:`${s+1} / ${t.length}`})}),e.jsxs("div",{className:[p.n23mSliderControlsButtons,"n23mSliderControlsButtons"].join(" "),children:[e.jsx(Y,{height:"50px",width:"50px",backgroundColor:"#F2F0EF",padding:0,title:"Prev",onClick:P,borderColor:"black",backgroundColorDisabled:"#F2F0EF",disabled:c||!n&&s===0,children:e.jsx(ie,{width:24,height:24})}),e.jsx(Y,{height:"50px",width:"50px",backgroundColor:"#F2F0EF",padding:0,title:"Next",borderColor:"black",backgroundColorDisabled:"#F2F0EF",onClick:V,disabled:c||!n&&s+l>=t.length,children:e.jsx(se,{width:24,height:24})})]})]})]})]})};v.displayName="Slider";v.__docgenInfo={description:"",methods:[],displayName:"Slider",props:{isCircular:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},children:{required:!0,tsType:{name:"ReactNode"},description:""},loading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},loaderColor:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"'black'",computed:!1}},slidesConfig:{required:!1,tsType:{name:"signature",type:"object",raw:`{
...
}`,computed:!1}},slideSpacingPx:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"10",computed:!1}}}};const{action:_}=__STORYBOOK_MODULE_ACTIONS__,we={title:"Slider/Slider",component:v,parameters:{layout:"centered",docs:{description:{component:`
...
}`,...B.parameters?.docs?.source}}};const _e=["Default","SliderCircular","SliderLoading","Slider1Slide","Slider2Slides"];export{$ as Default,O as Slider1Slide,B as Slider2Slides,F as SliderCircular,H as SliderLoading,_e as __namedExportsOrder,we as default};
