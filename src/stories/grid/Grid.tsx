...
export const Grid: React.FC<GridProps> = ({
  ...
  if (layout === 'container') {
    return (
      <div
        className={[styles.najwer23morselsGridContainer, 'MorselsGridContainer', className].filter(Boolean).join(' ')}
        style={
          {
  ...
  return (
    <div
      className={[styles.najwer23morselsGridColumns, 'MorselsGridColumns', className].filter(Boolean).join(' ')}
      style={
        {
